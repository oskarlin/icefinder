...
gdal_translate 1-2-1.jpg 1-2-1.tif -co "TILED=YES"
gdal_translate 3-6-7.jpg 3-6-7.tif -co "TILED=YES"
...
MAPNIK_MAP_FILE="image_cloud.xml" MAPNIK_TILE_DIR="$TILEPATH/$DATE_NASA" MAPNIK_MINZOOM="5" MAPNIK_MAXZOOM="11" python generate_tiles_imagery.py
